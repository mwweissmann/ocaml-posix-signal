...
(* OASIS_START *)
(* DO NOT EDIT (digest: eb85a1cb12608dcdc5376c9af9fb8f6d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "https://github.com/mwweissmann/ocaml-posix-signal/";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for POSIX signal";
                      doc_authors = [];
                      doc_abstract = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "posix-signal"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\005\236\180\130.?\168\127f\154\242\139Y\141\186\180";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
